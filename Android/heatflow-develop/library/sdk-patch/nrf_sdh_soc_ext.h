...
#include <nrf_sdh_soc.h>
         ...
         ************************************************************************************************************/
        #define NRF_SDH_SOC_OBSERVER_CPP(_name, _prio, _handler, _context)                                       \
         ...
         ************************************************************************************************************/
        #define NRF_SDH_SOC_EVENT_OBSERVERS_CPP(_name, _prio, _handler, _context, _cnt)                          \
        STATIC_ASSERT(NRF_SDH_SOC_ENABLED, "NRF_SDH_SOC_ENABLED not set!");                                      \
        STATIC_ASSERT(_prio < NRF_SDH_SOC_OBSERVER_PRIO_LEVELS, "Priority level unavailable.");                  \
        ...
        #define NRF_SDH_SOC_OBSERVER_CPP(A, B, C, D)     static int semicolon_swallow_##A
        #define NRF_SDH_SOC_OBSERVERS_CPP(A, B, C, D, E) static int semicolon_swallow_##A
        /*lint -restore */
