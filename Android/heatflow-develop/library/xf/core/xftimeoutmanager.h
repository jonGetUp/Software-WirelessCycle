...
public:
    ...
    /************************************************************************************************************//**
     * \brief   Returns a pointer to the created Timeout ItemPool list
     ****************************************************************************************************************/
    TimeoutList::ItemObjectPool * createTimeoutListItemPool(size_t objectCount);
#endif // XF_TM_USE_ISLIST_MEMPOOL

    /************************************************************************************************************//**
     * \brief   Sets the time interval in milliseconds in which the time-out manager should handle the time-outs.
     ****************************************************************************************************************/
    //void setTickInterval(uint16_t tickInterval);
     ...
     * \param   interval    The time in milliseconds to wait until the time-out expires.
     * \param   pReactive   The reactive instance where to inject the time-out when it time-outs.
     ****************************************************************************************************************/
     void scheduleTimeout(uint8_t timeoutId, int interval, IXFReactive* pReactive);
