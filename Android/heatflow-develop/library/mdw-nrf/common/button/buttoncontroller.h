...
/*                                                                                                                  */
/* **************************************************************************************************************** */
#define NB_MAX_BUTTONS                      NB_MAX_GPIOS
...
extern "C" 
{
    ...
    namespace gpio 
    {
         ...
         ************************************************************************************************************/
        void btnCtrlTimeoutHandler(void* pContext);
    }
#if defined(__cplusplus)
}
#endif
...
namespace gpio
{
    ...
    class ButtonController : public BaseController, public GpioObserver
    {
        ...
        friend void btnCtrlTimeoutHandler(void* pContext);
