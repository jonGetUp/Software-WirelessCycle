...
#include "gpio/gpio.h"
#include "button/buttonid.h"
#include "button/interface/buttonobserver.h"
#include "button/buttonPersistor.h"
...
namespace gpio
{
    ...
    /*                                                                                                              */
    /* ************************************************************************************************************ */
    class Button : public ISubject<ButtonObserver> 
    #if (USE_FLASH != 0)
    ...
    public:
        ...
        typedef enum
        {
            ...
            ButtonReleased = 255    ///< Button released.
        } eButtonState;
